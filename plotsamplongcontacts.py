...
for i in family_list:
    ...
    plt.plot(x,ppvS8, label="Sampled Data Transformer")
    # np.save("ppvo_"+str(i)+"npy",ppvO )
    # np.save("ppv8_"+str(i)+"npy",ppvS8 )
    plt.title("Inter-Domain Contact Prediction:" + str(famname), fontsize=37)
    plt.xlabel("Number of Predicted Pairs",fontsize=37)
    plt.ylabel("Positive Predictive Value",fontsize=37)
