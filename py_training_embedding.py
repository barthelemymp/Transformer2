...
sys.path.append("")
from model_Trans_Embedding import * 
from utils import *
...
tf_board_dir = "graph_embedding_ddi"
...
len_input = 101 #number of amino acids in the input sequence
len_output = 118  
...
for epoch in range(num_epochs):
    ...
    for batch_idx, batch in enumerate(train_iterator):
        ...
        # plot to tensorboard avg across epochs
