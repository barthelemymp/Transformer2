...
for i in ilist:# range(1000,1500):
    ...
    if os.path.isfile(modelpath):
        ...
        ax1.set_ylabel("$\mathcal{PP}$ - Perplexity", fontsize=35)
        ...
        plt.title("Perplexity and Accuracy at Different Distance from Training Set for"+famname, fontsize=35)
        ...
        ax1.legend(lns, labs,fontsize=35, loc=6)
