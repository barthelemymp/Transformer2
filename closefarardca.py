...
ilist = [975,17, 46, 69, 258, 97,103,132, 192, 197,972, 980, 1208, 1213, 1214, 71,157,160,251, 303,304,308,358,504, 634, 815, 972, 181] 
save_model = False
onehot=False
for i in ilist:# range(1000,1500):
    ...
    if os.path.isfile(modelpath):
        ...
        print("median", (dval1+dval2).min(dim=0)[0].median(), sum(maskValclose), sum(maskValfar))
        ...
        print("score", i)
        scoHVal = scipy.optimize.linear_sum_assignment(scoreHungarianVal_Ardca)
