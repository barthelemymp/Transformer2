# -*- coding: utf-8 -*-
"""
Created on Sun Dec 26 14:54:33 2021
...
for wd in wd_list:
    ...
    for i in ilist:
        ...
        #whyyy 'cpu?'
        wandb.init(project="Finetuning HNS PPI", entity="barthelemymp")
        config_dict = {
          ...
          "alphaParameter":0.0,
          "weight_decay":wd,
          "ardcaTrain":ardcaTrain,
          "ardcaTest":ardcaTest,
          "ardcaVal":ardcaVal,
          "ardcascoreH":ardcascoreH
        }
        ...
        for epoch in range(num_epochs+1):
            ...
            if epoch%1000==999:
                ...
                save_checkpoint(checkpoint, filename="transPPI"+str(i)+"_wd"+str(wd)+"_simple_epoch"+str(epoch)+"_"+str(num_encoder_layers)+"_"+str(forward_expansion)+".pth.tar")
        wandb.finish()
        ...
        #     }
        #     wandb.config.update(config_dict) 
        #     load_checkpoint(torch.load("transPPI"+str(i)+"_wd"+str(wd)+"_simple_epoch"+str(5000)+"_"+str(num_encoder_layers)+"_"+str(forward_expansion)+".pth.tar"), model, optimizer)
        #     step = 0
        #     step_ev = 0
        #     device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        #     print(device)
